...
ts.plot(data, main = "Figure 11.1: Time Series of Daily NYSE Returns", xlab = "Time", ylab = "Return", ylim = c(-0.08, 0.06))
dev.copy2pdf(file = "Fig 11.1 Time Series of Daily NYSE Returns.pdf")
## Fig 11.2 Correlogram of Daily Stock Market Returns ----
acf(data, type = "correlation", plot = T, ylim = c(-0.06, 1), main = "Figure 11.2: Correlogram of Daily Stock Market Returns", xlab = "Displacement", ylab = "Autocorrelation")
...
hist01 <- qplot(data, binwidth = 0.005, main = "Figure 11.3: Histogram and Statistics for Daily NYSE Returns", xlab = "Return", ylab = "Count", ylim = c(0, 1200))
hist01 <- hist(data, main = "Figure 11.3: Histogram and Statistics for Daily NYSE Returns", xlab = "Return", ylab = "Count", ylim = c(0, 1200), breaks = seq(-0.065, 0.065, by = 0.005))
...
data2 <- data * data
ts.plot(data2, main = "Figure 11.4: Time Series of Daily Squared NYSE Returns", xlab = "Time", ylab = "Squared Return", ylim = c(0.000, 0.005))
...
acf(data2, type = "correlation", plot = T, ylim = c(-0.04, 0.16), main = "Figure 11.5: Correlogram of Daily Squared Stock Market Returns", xlab = "Displacement", ylab = "Autocorrelation")
...
plot(acf.res, type = "h", ylab = "Autocorrelation", xlab = "Displacement", ylim = c(-0.04, 0.04))
abline(h = 0, par(xpd = FALSE))
