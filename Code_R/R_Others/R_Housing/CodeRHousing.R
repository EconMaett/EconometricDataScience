...
## Fig 16. Starts Sample Autocorrelations and Partial Autocorrelations ----
...
## Fig 16. Completions Sample Autocorrelations and Partial Autocorrelations ----
...
## Fig 16. VAR Starts Equation Residual Sample Autocorrelations ----
