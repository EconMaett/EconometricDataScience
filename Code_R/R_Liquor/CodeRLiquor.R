...
# 2. Before loading the packages, please make sure you have installed all the relevant packages in your RStudio.
#    You may use the following snippet of the code to install packages: install.packages("forecast")
# 3. To have the output graph saved, please un-comment the lines with pdf command and dev.off command.
#    Before producing the graph, you may want to create a folder named "tabfig" in your directory.
# Updates:  Finalized 8/15/2017
# *********************************************************************************************************
